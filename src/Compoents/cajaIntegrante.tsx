...
export default function Cajaescuadra({ escuadra, seleccionarCuadro,deseleccionarCuadro }: Props) {
  ...
  return (
    <div
      ...
      className={` h-7 w-7  flex items-center justify-center cursor-pointer hover:bg-blue-100`}
    >
      <div  className={`${colorClass} h-5 w-5 flex items-center justify-center `}>
